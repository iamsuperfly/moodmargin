...
export default function Markets() {
  ...
  // Live WebSocket prices — overlay on top of market data
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        ...
        {isLoading && (
          <div className="py-16 text-center text-muted-foreground text-sm">Loading markets...</div>
        )}

        {!isLoading && filtered.length === 0 && (
          <div className="py-16 text-center text-muted-foreground text-sm">No markets found</div>
        )}
        ...
        {filtered.map((market) => (
          ...
          >
            ...
            {/* Price — prefer live WebSocket price */}
            {(() => {
              const live = livePrices.get(market.symbol);
              const displayPrice = live?.price ?? market.currentPrice;
